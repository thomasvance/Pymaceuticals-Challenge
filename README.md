...
<br>
* A Bar Chart displaying the "Timepoint" for all mice tested for each "Drug Regimen" during the course of the study: <br>
<br>
![PyBar](https://github.com/user-attachments/assets/7911268f-e001-44d0-8283-3d09d8ea2916) <br>
<br>

* Pie Chart showing the distribution of female to male mice in the study: <br>
<br>
